...
namespace Traveller.StaticData
{
    public static class MalaysiaVisas
    {
        ...
        public static Visa eVisa_Malaysia = new Visa
        {
            ...
            "If you are travelling in another country on vacation and holding a tourist visa  of that country, you cannot apply eVISA online. It is advisable to apply your eVISA in your country of origin if you are planning to return to your country of origin at the end of your travel.Otherwise, your other alternative is applying a normal visa at the High Commission,  Consulate or Embassy of Malaysia nearest to you",
            Validity = 90,          
            OnLine = true,
            OnArrival = false,
            Duration = 30,            
