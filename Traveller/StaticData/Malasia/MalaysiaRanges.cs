         ...
         ,
            ...
            EntityDescription_ByMonth = new EntityFrameworkDictionary<string, string>()
            {
                ...
                Items = new List<DictionaryItem<string, string>>()
                {
                    ...
                    new DictionaryItem<string,string> { Key = "January",Value ="With the west coast basking in sunshine, it’s a fantastic time to visit Langkawi, Penang, Kuala Lumpur, Malacca and the Cameron highlands. On the east coast, however, the rainy season ensues so is best avoided. The east of Malaysia, including islands like Tioman, Redang and the Perhentian Islands, see heavy rains between November and February. These showers can be longer and heavier than those in the west, so we generally advise travellers to avoid the east of Malaysia at this time. " },

                    new DictionaryItem<string,string> { Key = "February", Value ="With the west coast basking in sunshine, it’s a fantastic time to visit Langkawi, Penang, Kuala Lumpur, Malacca and the Cameron highlands. On the east coast, however, the rainy season ensues so is best avoided. The east of Malaysia, including islands like Tioman, Redang and the Perhentian Islands, see heavy rains between November and February. These showers can be longer and heavier than those in the west, so we generally advise travellers to avoid the east of Malaysia at this time. " },

                    new DictionaryItem<string,string> { Key = "March", Value ="With the west coast basking in sunshine, it’s a fantastic time to visit Langkawi, Penang, Kuala Lumpur, Malacca and the Cameron highlands. On the east coast, however, the rainy season ensues so is best avoided." },

                    new DictionaryItem<string,string> { Key = "April", Value ="In April, weather in Malaysia is good across the country. The west and east coasts both enjoy lovely weather. The cultural centres of Kuala Lumpur, Cameron Highlands and Penang might have a few odd showers but not enough to affect your trip; they might even be a welcome relief from the humidity." },

                    new DictionaryItem<string,string> { Key = "May", Value ="The East Coast enjoys dry weather and glorious sunshine. The sea is relatively calm, perfect for snorkelling explorations around coral reefs. The west coast, on the other hand, is now in its rainy season, so heavy downpours should be expected, albeit short-lived." },

                    new DictionaryItem<string,string> { Key = "June",Value ="The East Coast enjoys dry weather and glorious sunshine. The sea is relatively calm, perfect for snorkelling explorations around coral reefs. The west coast, on the other hand, is now in its rainy season, so heavy downpours should be expected, albeit short-lived." },
                    ...
                    new DictionaryItem<string,string> { Key = "August", Value ="The East Coast enjoys dry weather and glorious sunshine. The sea is relatively calm, perfect for snorkelling explorations around coral reefs. The west coast, on the other hand, is now in its rainy season, so heavy downpours should be expected, albeit short-lived." },
