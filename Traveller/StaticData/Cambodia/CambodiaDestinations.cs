...
namespace Traveller.StaticData
{
    ...
    {
        public static Destination Bavet = new Destination { DestinationCountryID = 5, Name = "Bavet", DestinationTypes = new List<DestinationType> { DestinationTypes.BorderCrossing } };
        public static Destination PrekChak = new Destination { DestinationCountryID = 5, Name = "Prek Chak", DestinationTypes = new List<DestinationType> { DestinationTypes.BorderCrossing } };

        public static Destination KaanSamnor = new Destination { DestinationCountryID = 5, Name = "Kaan Samnor", DestinationTypes = new List<DestinationType> { DestinationTypes.BorderCrossing } };
        public static Destination KamSamnar = new Destination { DestinationCountryID = 5, Name = "K'am Samnar", DestinationTypes = new List<DestinationType> { DestinationTypes.BorderCrossing } };
        public static Destination Prom = new Destination { DestinationCountryID = 5, Name = "Prom", DestinationTypes = new List<DestinationType> { DestinationTypes.BorderCrossing } };
        public static Destination ChamYeam = new Destination { DestinationCountryID = 5, Name = "Cham Yeam", DestinationTypes = new List<DestinationType> { DestinationTypes.BorderCrossing } };
        public static Destination TropaengKreal = new Destination { DestinationCountryID = 5, Name = "Tropaeng Kreal", DestinationTypes = new List<DestinationType> { DestinationTypes.BorderCrossing } };
        ...
        public static Destination Angkor = new Destination { DestinationCountryID = 5, Name = "Angkor", Picture = "Angkor.jpg", DestinationTypes = new List<DestinationType> { DestinationTypes.Tourism } };
