...
namespace Traveller.StaticData
{
    public static class LaosDestinations
    {
        ...
        public static Destination Vientiane = new Destination { DestinationCountryID = 1, Name = "Vientiane", DestinationTypes = new List<DestinationType> { DestinationTypes.Frontier, DestinationTypes.Airport }, Description = "Vientiane" };
        ...
        public static Destination HuayXai = new Destination { DestinationCountryID = 1, Name = "Huay Xai", DestinationTypes = new List<DestinationType> { DestinationTypes.Frontier, DestinationTypes.Airport, DestinationTypes.Tourism }, Description = "Here begins the downstream crossing of the Mekong to Luang Prabang." };
