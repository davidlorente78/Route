...
namespace Traveller.StaticData
{
    public static class LaosDestinations
    {
        ...
        public static Destination Vientiane = new Destination { DestinationCountryID = 1, Name = "Vientiane", DestinationTypes = new List<DestinationType> { DestinationTypes.BorderCrossing, DestinationTypes.Airport }, Description = "Vientiane" };
        ...
        public static Destination LuangPrabang = new Destination { DestinationCountryID = 1, Name = "Luang Prabang", DestinationTypes = new List<DestinationType> { DestinationTypes.Tourism, DestinationTypes.Airport }, Description = "Luang Prabang" };
        public static Destination HuayXai = new Destination { DestinationCountryID = 1, Name = "Huay Xai", DestinationTypes = new List<DestinationType> { DestinationTypes.BorderCrossing, DestinationTypes.Airport, DestinationTypes.Tourism }, Description = "Here begins the downstream crossing of the Mekong to Luang Prabang." };
