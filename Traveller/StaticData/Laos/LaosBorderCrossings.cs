...
namespace Traveller.StaticData
{
    public static class LaosBorderCrossings
    {
        ...
        public static BorderCrossing Frienship_Bridge_II = new BorderCrossing
        {
            ...
            Description = "Bridge over the Mekong that connects Mukdahan Province in Thailand with Savannakhet in Laos. Located in the northeastern region known as Isaan, " +
            "Mukdahan and Savannakhet are separated by a bridge spanning the mighty Mekong River (the second “Friendship Bridge”). " +
            "This crossing is very popular with ex-pats and tourists due to the Thai embassy in Savannakhet, which has long been known as one of the friendlier embassies " +
            "where you can obtain a new visa and then re-enter Thailand. Savannakhet, although a fairly small, dusty provincial Laos town, does have a few markets, bars, " +
            "and various restaurants, as well as a casino and, will keep you busy for a day or two whilst you wait for your visa to be processed (which is an overnight process). " +
            "It is about two hours from Nakhon Phanom and there are two buses an hour from Mukdahan. There is no train line to Mukdahan",
        ...
        {
            Name = "Laos Cambodia - Tropaeng Kreal Border Post",
            DestinationOrigin = CambodiaDestinations.TropaengKreal,
            DestinationFinal = LaosDestinations.NongNokKhiene,
            BorderCrossingType = BorderCrossingTypes.Terrestrial,
            Description = "This land border crossing is called Nong Nok Khiene on the Laos side and Tropaeng Kreal on the Cambodia side. " +
            "The Cambodian province of Stung Treng borders the 4,000 Islands area of southern Laos."
        };
