...
namespace Traveller.DomainServices
{
    public class BorderCrossingService : IBorderCrossingService
    {
        ...
        public ICollection<BorderCrossing> GetBorderCrossingsByOriginCountryID(int CountryID)
        {
            ...
            var borderCrossings = unitOfWork.BorderCrossings.GetBorderCrossingsByOriginCountryCode(CountryID);
        ...
        {
            ///Metodo especifico para Repositorio en Countries. No es del repositorio generico.
            var borderCrossings = unitOfWork.BorderCrossings.GetBorderCrossingsByFinalCountryCode(CountryID);
        ...
        {
            ///Metodo especifico para Repositorio en Countries. No es del repositorio generico.
            var borderCrossings = unitOfWork.BorderCrossings.GetBorderCrossingsByOriginAndFinalCountryCode(originCountryID, finalCountryID);
