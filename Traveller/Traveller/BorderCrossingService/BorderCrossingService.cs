...
namespace Traveller.DomainServices
{
    public class BorderCrossingService : IBorderCrossingService{
        ...
        public ICollection<BorderCrossing> GetFrontiersByOriginCountryID(int CountryID)
        {
        ...
        public ICollection<BorderCrossing> GetFrontiersByFinalCountryID(int CountryID)
        {
            ///Metodo especifico para Repositorio en Countries. No es del repositorio generico.
        ...
        public ICollection<BorderCrossing> GetFrontiersByOriginAndFinalCountryCode(int originCountryID,int finalCountryID)
        {
            ///Metodo especifico para Repositorio en Countries. No es del repositorio generico.
