...
namespace Traveller.RouteService.DataContainer
{
    ...
    {
        public List<RangeCharWithDictionary> monsoonDaysData = new List<RangeCharWithDictionary>();
        ...
        public MonzonDataContainer()
        {
            ...
            monsoonDaysData = new List<RangeCharWithDictionary> {
                new RangeCharWithDictionary { Id = 'M', Description = new Dictionary<char, string>()
                    {
