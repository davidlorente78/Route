...
namespace RouteDataManager.ViewModels
{
    public class ItineraryIndexViewModel
    {
        ...
        public Month FilterStartMonth { get; set; } = new Month() { Name = "December", Id = 12 }; //Enero es 1 en Base de Datos

        public SelectList SelectListStartMonth { get; set; }

        public Month FilterEndMonth { get; set; } = new Month() { Name = "February", Id = 2 };
