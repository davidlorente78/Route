...
namespace RouteDataManager.Views.Destinations
{
    ...
    public class DestinationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DestinationID,CountryCode,Name,Description,Type")] Destination destination)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DestinationID,CountryCode,Name,Description,Type")] Destination destination)
        {
