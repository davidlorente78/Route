...
namespace RouteDataManager.Repositories
{
    public class CountryRepository : GenericRepository<Country>, ICountryRepository
    {
        ...
        public IEnumerable<Country> GetCountriesOrderedByName()
        {
            ...
            countryList = _context.Countries.Include(c => c.Destinations).ThenInclude(d => d.DestinationTypes).Include(c => c.Frontiers).ThenInclude(f => f.FrontierType).Include(c => c.Visas).OrderBy(c => c.Name).ToList();
