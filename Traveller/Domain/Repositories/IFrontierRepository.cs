...
namespace Domain.Repositories
{
    ...
    /// </summary>
    public interface IFrontierRepository : IGenericRepository<BorderCrossing>
    {
        IEnumerable<BorderCrossing> GetFrontiersByOriginCountryCode(int CountryID);

        IEnumerable<BorderCrossing> GetFrontiersByFinalCountryCode(int CountryID);

        IEnumerable<BorderCrossing> GetFrontiersByOriginAndFinalCountryCode(int originCountryID, int finalCountryID);
